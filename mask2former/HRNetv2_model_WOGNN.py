...
class HRNet_W48_WOGNN_ARCH(nn.Module):
    """
    ...
    def __init__(self, *, 
        ...
        super(HRNet_W48_WOGNN_ARCH, self).__init__()
    ...
    def from_config(cls, cfg):
        ...
        loss_weight_dict = {"loss_ce0": 1, "loss_ce1": 3, "loss_ce2": 1, "loss_ce3": 1, "loss_ce4": 1, "loss_ce5": 3, "loss_ce6": 2, "loss_aux0": 1, "loss_aux1": 3, "loss_aux2": 1, "loss_aux3": 1, "loss_aux4": 1, "loss_aux5": 3, "loss_aux6": 2, "loss_spa": 0.1, "loss_adj":1, "loss_orth":10}
